        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    <?php if ($row->imagen){ ?>
                        <div class="card-image">
                            <img src="<?php echo $_SESSION['public']."img/".$row->imagen ?>" alt="<?php echo $row->equipo ?>">
                        </div>
                    <?php } ?>
                    <div class="card-content">
                        <?php if (!$row->imagen){ ?>
                        ...
                        <strong>Fundacion:</strong> <?php echo date("d/m/Y", strtotime($row->fundacion)) ?>
                    </div>
                    <div class="card-action">
                ...
                <div class="card-reveal">
                    ...
                    <p>
                        ¿Está seguro de que quiere borrar la noticia<strong><?php echo $row->equipo ?></strong>?<br>

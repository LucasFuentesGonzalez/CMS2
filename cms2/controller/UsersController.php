...
class UsersController
{
    ...
    public function entrar(){
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            $campo_clave = filter_input(INPUT_POST, "clave1", FILTER_SANITIZE_STRING);
            ...
            if ($usuario){
                //Compruebo la clave
                if (password_verify($campo_clave,$usuario->clave1)) {
    ...
    public function index(){
        ...
        while ($row = $rowset->fetch(\PDO::FETCH_OBJ)){
            array_push($usuarios,new User($row));
        }
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $clave1 = filter_input(INPUT_POST, "clave1", FILTER_SANITIZE_STRING);
            ...
            //Encripto la clave
            $clave_encriptada = ($clave1) ? password_hash($clave1,  PASSWORD_BCRYPT, ['cost'=>12]) : "";

            if ($id == "nuevo"){

                //Creo un nuevo usuario
                $this->db->exec("INSERT INTO users (usuario, clave1, noticias, usuarios) VALUES ('$usuario','$clave_encriptada',$noticias,$usuarios)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE users SET usuario='$usuario',clave1='$clave_encriptada',noticias=$noticias,usuarios=$usuarios WHERE id='$id'") :
                    $this->db->exec("UPDATE users SET usuario='$usuario',noticias=$noticias,usuarios=$usuarios WHERE id='$id'");

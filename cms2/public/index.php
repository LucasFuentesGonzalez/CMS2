...
use App\Controller\ContenidoController;
use App\Controller\UsersController;


//echo password_hash("Madrid12345", PASSWORD_BCRYPT, ['cost' => 12]);
 ...
 */
$_SESSION['public'] = '/2.Trimestre/cms2/public/';
...
function controlador($nombre=null){
    ...
    switch($nombre){
        ...
        case "noticias": return new ContenidoController; //Back end de noticias
        case "usuarios": return new UsersController; //Autenticacion y back end de usuario
    }
